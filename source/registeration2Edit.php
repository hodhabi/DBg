...
$sql = "Update registeration2 Set  StudentId='$vStudentId', Campus='$vCampus', StudentDivision='$vStudentDivision', Course='$vCourse', CourseDivision='$vCourseDivision', day='$vday' where id=$id ";
