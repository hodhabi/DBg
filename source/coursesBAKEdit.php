...
$sql = "Update coursesBAK Set  semester='$vsemester', day='$vday', nStudents='$vnStudents', Duration='$vDuration', Deliverytype='$vDeliverytype', ExamMethod='$vExamMethod' where Course=$Course ";
