...
function delete_id(id)
{
     ...
     {
        window.location.href='coursesBAKDelete.php?Course='+id;
     }
}
...
echo "<A class='btn btn-primary' href=coursesBAKform.php>Add a record</a>";
$sql = "select * from coursesBAK ";
...
$i = $i + 1;
echo "<tr>";
echo "<td><A class='btn btn-success' href='coursesBAKFormEdit.php?id=$idv'>Edit</A></td>";
